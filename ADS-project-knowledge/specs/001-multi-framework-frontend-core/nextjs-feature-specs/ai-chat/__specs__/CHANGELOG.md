...
- Reorganized implementation layout for portability:
  - `` for framework-agnostic TypeScript.
  - `react/{orchestrators,hooks,state,views}` for React-bound code.
...
- Added full ai-chat spec pack:
  ...
  - `spec-manifest.md`
- Normalized ai-chat type contracts into `features/ai-chat/__types__/`.
