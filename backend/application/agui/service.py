...
async def agui_event_stream(
    ...
    *,
    ...
    try:
        ...
        should_plan_actions = (
            is_probable_ui_action_request_fn(latest_user_text, sanitized_tools)
        ...
        plan_result = (
            run_unified_action_plan_fn(service_payload)
        ...
        mode, raw_output = run_unified_chat_fn(
            service_payload,
...
def create_agui_stream_response(
    ...
    *,
    ...
    return StreamingResponse(
        agui_event_stream(
            payload,
            is_probable_ui_action_request_fn=is_probable_ui_action_request_fn,
            run_unified_action_plan_fn=run_unified_action_plan_fn,
            run_unified_chat_fn=run_unified_chat_fn,
        ),
