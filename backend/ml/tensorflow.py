...
"""Legacy compatibility shim for TensorFlow runtime paths."""
...
from .frameworks.tensorflow.handlers import (
    _handle_distill_request_impl,
    handle_distill_request,
    handle_train_request,
)
from .frameworks.tensorflow.trainer import (
...
def _build_arg_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="Train/test a TensorFlow model on CSV/XLS/XLSX tabular data")
