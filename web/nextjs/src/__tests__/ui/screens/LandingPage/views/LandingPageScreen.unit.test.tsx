...
vi.mock("@/features/recharts/react/views/screens/ChartsWorkspaceSurface", () => ({
  default: () => <div data-testid="landing-charts-workspace" />,
}));

import LandingPageScreen from "@/ui/screens/LandingPage/views/LandingPageScreen";
...
describe("LandingPageScreen", () => {
  ...
  it("renders the page chrome and fires an error demo toast from the URL", () => {
    ...
    expect(screen.getByTestId("landing-charts-workspace")).toBeInTheDocument();
