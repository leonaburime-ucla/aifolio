...
vi.mock("@/features/ml-model-ui/react/hooks/useModelPreviewModel.hooks", () => ({
...
import { ModelPreviewModal } from "@/features/ml-model-ui/react/views/components/ModelPreviewModal";
