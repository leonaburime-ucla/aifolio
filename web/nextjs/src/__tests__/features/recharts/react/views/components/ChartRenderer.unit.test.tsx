...
vi.mock("@/features/recharts/react/hooks/useChartRendererModel.hooks", () => ({
  useChartRendererModel: (params: unknown) => useChartRendererModelMock(params),
}));

vi.mock("@/features/recharts/react/views/components/EChartsRenderer", () => ({
  default: () => <div data-testid="echarts-renderer" />,
}));

vi.mock("@/ui/components/General/Modal", () => ({
  Modal: ({
    isOpen,
    onClose,
    children,
...
} from "@/features/recharts/react/views/components/ChartRenderer";
