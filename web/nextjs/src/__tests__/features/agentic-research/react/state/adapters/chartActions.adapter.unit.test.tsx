...
vi.mock("@/features/agentic-research/react/state/zustand/agenticResearchChartStore", () => ({
...
} from "@/features/agentic-research/react/state/adapters/chartActions.adapter";
