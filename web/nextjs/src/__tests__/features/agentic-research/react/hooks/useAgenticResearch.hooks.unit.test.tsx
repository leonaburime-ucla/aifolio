...
} from "@/features/agentic-research/react/hooks/useAgenticResearch.hooks";
import type { AgenticResearchDeps } from "@aifolio/contracts/entities/agentic-research";

type AgenticResearchDepsOverrides = {
  state?: Partial<AgenticResearchDeps["state"]>;
  actions?: Partial<AgenticResearchDeps["actions"]>;
  api?: Partial<AgenticResearchDeps["api"]>;
};

function createDeps(overrides: AgenticResearchDepsOverrides = {}): AgenticResearchDeps {
