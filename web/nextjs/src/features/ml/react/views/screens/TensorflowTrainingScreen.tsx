...
import { FieldHelp } from "@/features/ml/react/views/components/FieldHelp";
import { TrainingRunsSection } from "@/features/ml/react/views/components/TrainingRunsSection";
import {
  DistillMetricsModal,
  OptimalParamsModal,
} from "@/features/ml/react/views/components/MlTrainingModals";
import {
  ModelPreviewModal,
} from "@/features/ml-model-ui/react/views/components/ModelPreviewModal";
import {
...
import { useMlDatasetOrchestrator } from "@/features/ml/react/orchestrators/mlDataset.orchestrator";
import { useMlTrainingRunsAdapter } from "@/features/ml/react/state/adapters/mlTrainingRuns.adapter";
import {
  getTensorflowModeExplainer,
} from "@aifolio/frontend-core/ml-training";
import { useTensorflowFormBridge } from "@/features/ml/react/ai/tools/useTensorflowFormBridge.tools";
...
export default function TensorFlowPage({
  ...
  const modeExplainer = getTensorflowModeExplainer(trainingMode);
