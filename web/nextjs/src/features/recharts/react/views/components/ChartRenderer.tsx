...
import {
  ...
  formatXAxisValue,
  SERIES_COLORS,
} from "@aifolio/frontend-core/recharts";
import EChartsRenderer from "@/features/recharts/react/views/components/EChartsRenderer";
import { Modal } from "@/ui/components/General/Modal";
import type {
  ChartRendererProps,
  LoadingLabelProps,
} from "@/features/recharts/react/views/components/ChartRenderer.types";
import { useChartRendererModel } from "@/features/recharts/react/hooks/useChartRendererModel.hooks";
...
export function LoadingLabel({
  ...
  return (
    <text x={resolvedX + 6} y={resolvedY - 6} fontSize={10} fill="#52525b">
      {String(value)}
    </text>
  );
}
