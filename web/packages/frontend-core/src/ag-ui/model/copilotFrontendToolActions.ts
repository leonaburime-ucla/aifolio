...
export type CopilotFrontendToolActions = {
  ...
  randomizeActiveMlFormFields: CopilotToolAction<PytorchRandomizeArgs>;
  ...
  randomizePytorchFormFields: CopilotToolAction<PytorchRandomizeArgs>;
  ...
  randomizeTensorflowFormFields: CopilotToolAction<TensorflowRandomizeArgs>;
};

export type CreateCopilotFrontendToolActionsArgs = {
  ...
  handleRandomizeActiveMlFormFields: (args: PytorchRandomizeArgs) => Promise<string>;
  ...
  handleRandomizePytorchFormFields: (args: PytorchRandomizeArgs) => Promise<string>;
  ...
  handleRandomizeTensorflowFormFields: (args: TensorflowRandomizeArgs) => Promise<string>;
};
...
/**
 * Creates Copilot frontend action definitions from injected handlers.
 *
 * @param args - Injected behavior handlers for each action.
 * @returns Structured action definitions for registration by a framework adapter.
 * @complexity O(1) time and space; the returned action count is fixed.
 * @overallScore 100
 */
