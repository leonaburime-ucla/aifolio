...
import type { CopilotAssistantPayload } from "@aifolio/contracts/entities/ag-ui";
...
export function normalizeChartSpec(raw: unknown, fallbackId: string): ChartSpec | null {
