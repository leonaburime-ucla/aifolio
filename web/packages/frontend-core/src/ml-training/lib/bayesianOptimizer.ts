...
export type { HyperParams } from "@aifolio/contracts/entities/ml-training";
 ...
 * @complexity O(r + s*p*r) time and O(r + p) space for r parsed runs, s=500 samples, p=7 parameters.
 * @overallScore 100
 */
