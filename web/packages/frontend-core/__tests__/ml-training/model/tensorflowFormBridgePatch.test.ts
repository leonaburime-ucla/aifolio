...
import { applyTensorflowBridgePatch } from "@aifolio/frontend-core/ml-training";
import type { TensorflowBridgePatchBindings } from "@aifolio/contracts/entities/ml-training";
