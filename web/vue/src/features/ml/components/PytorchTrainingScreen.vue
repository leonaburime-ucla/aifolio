...
import { getPytorchModeExplainer } from "@aifolio/frontend-core/ml-training";
  ...
  <div class="flex min-h-screen flex-row bg-white text-zinc-900">
    <main class="min-w-0 flex-1 py-10">
      <div class="mx-auto flex max-w-5xl flex-col gap-4 px-6">
        ...
        <!-- Hyperparameters -->
        <section class="rounded-xl border border-zinc-200 bg-white p-4">
          <p class="text-xs font-semibold uppercase tracking-wide text-zinc-500">Train PyTorch Model</p>
          <div class="mt-3 grid max-w-3xl grid-cols-1 gap-3 md:grid-cols-3">
            <label class="flex flex-col gap-1 text-xs text-zinc-600">
            ...
            <label class="flex flex-col gap-1 text-xs text-zinc-600">
              <span>Epoch Values</span>
              <input v-model="epochValues" class="rounded-md border border-zinc-300 px-2 py-1 text-sm text-zinc-900" placeholder="e.g. 10,20,50,100,200" />
            </label>
            <label class="flex flex-col gap-1 text-xs text-zinc-600">
              <span>Batch Sizes</span>
              <input v-model="batchSizes" class="rounded-md border border-zinc-300 px-2 py-1 text-sm text-zinc-900" placeholder="e.g. 32,64,128" />
            </label>
            <label class="flex flex-col gap-1 text-xs text-zinc-600">
              <span>Learning Rates</span>
              <input v-model="learningRates" class="rounded-md border border-zinc-300 px-2 py-1 text-sm text-zinc-900" placeholder="e.g. 0.001,0.0005" />
            </label>
            <label class="flex flex-col gap-1 text-xs text-zinc-600">
              <span>Test Sizes</span>
              <input v-model="testSizes" class="rounded-md border border-zinc-300 px-2 py-1 text-sm text-zinc-900" placeholder="e.g. 0.2,0.3" />
            </label>
